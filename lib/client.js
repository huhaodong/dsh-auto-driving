window.__ModuleLoader__.load({
	...
	factory: (require) => {
		 ...
		 * full-auto decision (auto-answered question / auto-allowed permission).
		...
		function ringEventText(entry, t) {
			...
			if (autoAllowed) return { text: `${t("autoAnsweredNotice")}: ${autoAllowed[1]}` };
			if (autoPermission) return { text: `${t("autoAllowedNotice")}: ${autoPermission[1]}` };
			return null;
		}
